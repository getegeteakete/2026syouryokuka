...
function LandingPage({setPage,setCaseId}){return(<div><HeroSection setPage={setPage}/><SchedSection/><SubTable/><FeatSection/><CasesSection setPage={setPage} setCaseId={setCaseId}/>
  <section style={{background:`linear-gradient(135deg,${C.gS},${C.gE})`,padding:"80px 24px",textAlign:"center"}}><h2 style={{color:"#fff",fontSize:32,fontWeight:900,marginBottom:12}}>補助金申請、もっとカンタンに。</h2><p style={{color:"rgba(255,255,255,0.65)",fontSize:16,marginBottom:32}}>AI＋音声入力で対話型フルサポート。</p>
